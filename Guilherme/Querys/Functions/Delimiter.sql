...
DELIMITER // -- usamos o seguinte comando para criar uma função que possui varios pontos e virgulas, 
...
END //
DELIMITER ; -- no final para reconhecer que aqui e a virgula final