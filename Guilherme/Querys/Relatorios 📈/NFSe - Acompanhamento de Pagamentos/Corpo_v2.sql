...
inner join nota_fiscal nf on
	nf.idatendimento_paciente = crcm.idatendimento_paciente and nf.cd_verificacao_nfse is not null and nf.dt_cancelamento is null 
	and nf.ie_status_envio = 'A' and nf.status = 'A'
